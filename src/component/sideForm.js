...
const SideForm = ({setNext}) => {
    return (
        <div className='w-fit mx-auto my-auto'> 
            <button onClick={() => setNext(true)} className='h-14 w-[336px] font-semibold text-base rounded-full bg-gray-200 text-left pl-4 border hover:border-indigo-600 mb-4'>
